const INITIAL_DATA = {
  ...
  xp: 0, xpMax: 50,
  afinidade: 'FOGO',
  atributos: { for: 0, des: 1, con: 1, int: 3, sab: 0, car: 2 },
  salvaguardas: { for: true, des: false, con: true, int: true, sab: false, car: false },
  pvMax: 19, pvAtual: 19, pvTemp: 0,
  pcMax: 21, pcAtual: 15, pcTemp: 0,
  caProfBonus: 0, caOutros: 0, caAtrib: 'des', iniciativa: 0, iniciativaExtra: 0, deslocamento: 30, deslocamentoBase: 30, deslocamentoBonus: 0, impulso: 0, vontadeFogo: 0,
  sucessoMorte: 0, falhaMorte: 0,
  habilidades: {
    acrobacia: { prof: '1', base: 0, attr: 'des' },
    adestrar_animais: { prof: '', base: 0, attr: 'sab' },
    artes_marciais: { prof: '1', base: 0, attr: 'for' },
    atletismo: { prof: '', base: 0, attr: 'for' },
    construir: { prof: '', base: 0, attr: 'int' },
    controle_chakra: { prof: '1', base: 0, attr: 'con' },
    enganacao: { prof: '', base: 0, attr: 'car' },
    furtividade: { prof: '1', base: 0, attr: 'des' },
    historia: { prof: '', base: 0, attr: 'int' },
    ilusao: { prof: '1', base: 0, attr: 'sab' },
    intimidacao: { prof: '', base: 0, attr: 'car' },
    intuicao: { prof: '1', base: 0, attr: 'sab' },
    investigacao: { prof: '', base: 0, attr: 'int' },
    medicina: { prof: '', base: 0, attr: 'sab' },
    natureza: { prof: '', base: 0, attr: 'int' },
    ninshou: { prof: '1', base: 0, attr: 'int' },
    percepcao: { prof: '1', base: 0, attr: 'sab' },
  ...
  ataques: { ninjutsu: { bonus: 6, cd: 14 }, genjutsu: { bonus: 5, cd: 13 }, taijutsu: { bonus: 3, cd: 11 } },
  armas: [
    { nome: 'Kunai', dano: '1d4', tipo: 'Perfuração', propriedades: 'Leve, Sutileza, Arremesso (30/60), Múltiplo ataque, munição' },
    { nome: 'Shuriken', dano: '1d4', tipo: 'Perfuração', propriedades: 'Arremesso (30/120), Múltiplo ataque, munição' },
    { nome: 'Tanto (Espada Curta)', dano: '1d6', tipo: 'Cortante', propriedades: 'Leve, Sutileza, Mortal, Flexível (Cortante d4)' }
  ],
  proficiencias: 'Armadura: Leves, médias e Pesadas\nArmas: Simples e Marciais\nAdicionais: Kit de Amostra\nAfinidade: FOGO',
  maestrias: '',
  ...
  tracos: { cla: ['Sharingan: uma vez por rodada, você pode realizar uma Reação adicional.'], classe: ['Postura do Punho do Lobo'], subclasse: [], talentos: [] },
  aparencia: { idade: '', altura: '145', peso: '60', genero: '', cabelos: '', olhos: '', pele: '', aura: '', roupas: '', tamanho: '', marcas: '' },
  idiomas: '', tracoAntecedente: 'Ambição', motivacao: '', meta: '', medos: '', historia: '',
  missoes: { d: 0, c: 0, b: 0, a: 0, s: 0, sp: 0 },
  inventario: [],
  armadura: { nome: 'Jaqueta de combate Shinobi', bonusCA: 5, mod: 'DES', tipo: 'Armadura Média', peso: 4 },
  ryo: 100,
